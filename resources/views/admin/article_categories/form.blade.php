        ...
        <div class="col-xs-12">
            <section class="panel">
                <header class="panel-heading">
                    <h2 class="panel-title">Nhập tên danh mục tin tức</h2>
                </header>
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal form-bordered" action="/admin/article-categories" method="post">
                        @csrf
